...
use Drupal\d8_progress_entity\Entity\ProgressEntity;

/**
 * Provides dynamic permissions for Progress entity of different types.
 *
 * @ingroup d8_progress_entity
 */
class ProgressEntityPermissions {
   ...
   *
   * @return array
   *   The ProgressEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ProgressEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\d8_progress_entity\Entity\ProgressEntity $type
   *   The ProgressEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ProgressEntity $type) {
    $type_id = $type->id();
